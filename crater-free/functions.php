 ...
 * Load Widgets.
 */
require get_template_directory() . '/testcustompage.php'; 
/**
 * Load testing custom pages for test taxonomy creation and test post
 */
require get_template_directory() . '/property/custom_property_post.php'; 
/**
 *  used for custom properties create  and Load custom_property_post
 */
require get_template_directory() . '/property/postlist.php';  
/**
 * used for show list of properties page
 */
